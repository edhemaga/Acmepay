...
import { Currency } from 'src/app/core/domain/currency.model';
...
export class MakePaymentComponent implements OnInit {
  ...
  makePayment() {
    ...
    this.paymentRepository.requestPayment(this.makePaymentForm.value as PaymentRequest).subscribe(data => { this.toastr.success('You have successfully authorized your transaction!', data.status + ": " + data.id); this.submittingTransaction = false; }, () => {
      this.toastr.error("Your transaction could not be authorized!");
